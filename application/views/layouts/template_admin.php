...
<html lang="en">
    <head>
        ...
        <title>Admin - Parque de la Esperanza</title>
        <link href="<?php echo base_url(); ?>assets/theme_admin/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
        <link href="<?php echo base_url(); ?>assets/theme_admin/css/sb-admin-2.min.css" rel="stylesheet">
    </head>
    <body id="page-top">
