...
$route['servicios/necesidad-futura'] = 'servicios/necesidad_futura';
$route['servicios/necesidad-inmediata'] = 'servicios/necesidad_inmediata';
$route['servicios/otros-servicios'] = 'servicios/otros_servicios';


$route['crematorio'] = 'pages/crematorio';
$route['sepulturas'] = 'pages/sepulturas';
$route['galeria'] = 'pages/galeria';
